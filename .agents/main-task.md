You are executing one repository agent.

  Read these files first:
  - .agents/shared/plan.md
  ...
  - Follow the selected agent files exactly.
  - Stay strictly within this agent’s scope.
  - Do not do work owned by other agents.
